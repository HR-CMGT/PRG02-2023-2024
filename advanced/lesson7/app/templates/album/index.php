...
<a class="button" href="<?= BASE_PATH; ?>albums/create">Create new album</a>
<table class="table is-striped mt-4">
    ...
    <?php foreach ($albums as $album): ?>
        <tr>
            ...
            <td class="is-vcentered"><a href="<?= BASE_PATH; ?>albums/edit?id=<?= $album->id; ?>">Edit</a></td>
            <td class="is-vcentered"><a href="<?= BASE_PATH; ?>albums/delete?id=<?= $album->id; ?>">Delete</a></td>
        </tr>
    <?php endforeach; ?>
    </tbody>
</table>
