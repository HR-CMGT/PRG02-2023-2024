...
<div class="is-flex">
    <?php require_once '../../menu/panel.php'; ?>
    <div>
        <!--Opdracht 1-->
            ...
            <div class="content">
                ...
                <blockquote>
                    <p>Werk in tweetallen en één persoon beantwoordt de vragen in <a
                                href="https://brightspace.hr.nl/d2l/le/lessons/28859/topics/231583" target="_blank">Brightspace</a>.
                    </p>
                    <ol>
        ...
        <section class="section has-background-primary-light">
            ...
            <div class="content">
                ...
                <blockquote>
                    <p>Werk in tweetallen en één persoon beantwoordt de vragen in <a
                                href="https://brightspace.hr.nl/d2l/le/lessons/28859/topics/236084" target="_blank">Brightspace</a>.
                    </p>
                    <ol>
                        <li>Welke informatie / data heb je nodig als input voor deze opdracht?</li>
                        <li>Wat moet er stap voor stap gebeuren om het resultaat te bereiken? Let op! Je mag geen
        ...
        <section class="section">
            ...
            <div class="content">
                ...
                <blockquote>
                    Werk de <a href="strings/index.php"><strong>opdracht</strong></a> uit uit de folder <code>exercises/strings</code>
                </blockquote>
                <p>
